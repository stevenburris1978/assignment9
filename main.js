...
const getAllUsers = async () => {
    ...
    const postUsers = await responseTwo.json();
...
const getComments = async () => {
    const responseThree = await fetch("https://jsonplaceholder.typicode.com/posts/3");
    const postID = await responseThree.json();
    console.log(postID);
}
getComments();
...
const getUser = async () => {
    const responsefour = await fetch("https://jsonplaceholder.typicode.com/users/1");
    const userID = await responsefour.json();
    console.log(userID);
}
getUser();
